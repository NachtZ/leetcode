...
/**/
func main() {
	fmt.Println(leastBricks([][]int{[]int{1, 2, 2, 1}, []int{3, 1, 2}, []int{1, 3, 2}, []int{2, 4}, []int{3, 1, 2}, []int{1, 3, 1, 1}}))
	fmt.Println(leastBricks([][]int{[]int{100000000}, []int{100000000}, []int{100000000}}))
}
